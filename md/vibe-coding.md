...
使われるのがGemini 2.5 Proとかになるんだけど、Webアプリの機能追加で文字色と背景色を同じ色にしちゃって、再度修正を依頼しても修正してくれないとか結構ポンコツ。
...
Proプランの場合、5時間ごとと1週間ごとの2種類の制限があって、どちらかが制限に達するとリセットまでは使用不可になるらしい。`/status`コマンドで確認できるとか。
