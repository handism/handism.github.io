// src/components/tools/markup/MarkdownTable.tsx
'use client';
...
export default function MarkdownTable() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-text">
      {/* 左カラム: エディタグリッド */}
      <div className="lg:col-span-8 flex flex-col gap-6">
        <div className="theme-card p-5 md:p-6 space-y-6 border-2 border-border bg-card shadow-[4px_4px_0px_0px_var(--border)]">
          <div className="flex flex-wrap justify-between items-center gap-4 border-b-2 border-border/20 pb-3">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="theme-btn px-2.5 py-1 text-xs bg-secondary flex items-center gap-1 cursor-pointer"
              >
              ...
              <button
                ...
                className="theme-btn px-2.5 py-1 text-xs bg-card flex items-center gap-1 cursor-pointer"
              >
          ...
          {/* インポートテキストエリア */}
          {showImport && (
            <div className="p-4 border-2 border-dashed border-border/60 rounded-xl bg-secondary/20 space-y-3 shadow-inner">
              ...
              <div className="flex justify-end gap-2">
                <button
                  ...
                  className="px-3 py-1.5 border-2 border-border rounded-lg text-xs font-bold bg-card cursor-pointer"
                >
                  キャンセル
                </button>
                <button
                  onClick={handleImport}
                  className="px-3 py-1.5 border-2 border-border rounded-lg text-xs font-bold bg-accent text-white cursor-pointer"
                >
                  適用
                </button>
              </div>
          ...
          {/* スプレッドシートテーブル */}
          <div className="overflow-x-auto border-2 border-border rounded-xl bg-card shadow-[2px_2px_0px_0px_var(--border)]">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <button
                              ...
                              className="p-1 border-2 border-border/40 rounded bg-card text-text/75 hover:bg-secondary cursor-pointer"
                              title="位置合わせ切り替え"
                            >
                            ...
                            <button
                              ...
                              className="p-1 text-red-500 border-2 border-border/40 rounded bg-card hover:bg-red-50 disabled:opacity-40 cursor-pointer"
                              title="列削除"
                            >
                  ...
                  <tr key={rowIdx} className="hover:bg-secondary/5">
                    ...
                    <td className="p-2 text-center">
                      <button
                        ...
                        className="p-1 text-red-500 rounded hover:bg-red-50 disabled:opacity-40 cursor-pointer"
                        title="行削除"
                      >
      ...
      <div className="lg:col-span-4">
        <div className="theme-card p-5 md:p-6 flex flex-col h-full min-h-[400px] border-2 border-border bg-card shadow-[4px_4px_0px_0px_var(--border)]">
          ...
          <div className="flex-1 min-h-0">
            <textarea
              readOnly
              className="w-full h-full p-3 border border-border rounded-xl font-mono text-xs bg-slate-950 text-slate-100 focus:outline-none resize-none overflow-y-auto whitespace-pre leading-relaxed shadow-inner"
