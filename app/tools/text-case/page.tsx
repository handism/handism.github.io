...
export default function TextCaseConverter() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-rose-100 dark:from-slate-900 dark:to-slate-800 p-4 md:p-8">
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                入力テキストの文字数・単語数・バイト数を瞬時に計測し、各種プログラミングケースへ一括変換します。
              </p>
            </div>
          </div>
