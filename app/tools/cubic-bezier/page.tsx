...
export default function CubicBezierVisualizer() {
  ...
  return (
    <ToolPageLayout
      ...
      description="ドラッグやスライダーでイージング曲線を視覚的にデザインするツールです。実際に要素を動かしたデモ（他イージングとの比較）を確認し、CSSのトランジションコードを瞬時に取得できます。"
      icon={Activity}
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-6 space-y-6">
          <div className="theme-card p-5 bg-card space-y-5">
            ...
            {/* SVGベジェ曲線プロッター */}
            <div className="flex justify-center p-4 bg-secondary rounded-xl border border-border">
            ...
            <div className="space-y-2 pt-2 border-t border-border/10">
              <span className="text-xs font-extrabold block">イージングプリセット</span>
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="theme-card p-5 bg-card space-y-4">
            ...
            {/* アニメーションステージ */}
            <div className="p-4 bg-secondary rounded-xl border border-border space-y-5 relative overflow-hidden h-[180px] flex flex-col justify-center">
              {/* カスタムイージング */}
              <div className="space-y-1">
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center text-[10px] font-black text-text/60">
                  ...
                  <select
                    ...
                    className="border border-border p-0.5 rounded bg-card text-[9px]"
                  >
                    {PRESETS.map((p) => (
          ...
          <div className="theme-card p-5 bg-card space-y-3">
            ...
            <pre className="p-3 bg-[#1e1e1e] text-[#f8f8f2] font-mono text-[10px] rounded-lg border-2 border-border overflow-x-auto whitespace-pre-wrap leading-relaxed">
