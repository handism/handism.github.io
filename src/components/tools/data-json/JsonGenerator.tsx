// src/components/tools/data-json/JsonGenerator.tsx
'use client';
      ...
      <div className="lg:col-span-6 space-y-6">
        <div className="theme-card p-5 bg-card space-y-5">
          ...
          <div className="flex gap-3 pt-2">
            <button
              onClick={addField}
              className="flex-1 theme-btn px-4 py-2.5 text-xs flex items-center justify-center gap-1.5 hover:text-accent font-bold"
            >
            ...
            <button
              ...
              className="flex-1 theme-btn bg-accent text-white px-4 py-2.5 text-xs flex items-center justify-center gap-1.5 cursor-pointer font-bold"
            >
