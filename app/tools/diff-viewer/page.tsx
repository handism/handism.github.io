...
export default function DiffViewer() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-slate-900 dark:to-slate-800 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="bg-white dark:bg-slate-950 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-800 p-6 md:p-8">
          {/* Header */}
          <div className="flex items-center gap-3 mb-8">
            <GitCompare className="w-8 h-8 text-indigo-600 dark:text-indigo-400 animate-pulse" />
            <div>
              <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white">
                Diff Viewer
              </h1>
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                テキストの差分（追加・削除・変更箇所）を視覚的に比較・確認できます。
              </p>
            </div>
          </div>
