...
export const themeConfig = [
  ...
  },
  {
    id: 'glitch',
    label: 'Glitch Art',
    description: 'RGBズレ・スキャンライン・デジタルな崩壊表現',
    emoji: '⚡',
    category: 'tech',
    previewBg: '#050508',
    previewCard: '#0a0a12',
    previewAccent: '#ff0090',
  },
  {
    id: 'dark-ui',
    label: 'Dark UI Only',
  ...
  },
  {
    id: 'holographic',
    label: 'Holographic',
    description: 'オーロラ・クリスタル・プリズム発光・虹色グラデーション',
    emoji: '🌈',
    category: 'creative',
    previewBg: 'linear-gradient(135deg, #0f0a1a, #1a0f2e)',
    previewCard: 'rgba(255,255,255,0.08)',
    previewAccent: '#a855f7',
    previewBorderColor: 'rgba(168,85,247,0.4)',
    previewBackdropFilter: 'blur(8px)',
  },
  {
    id: 'bauhaus',
