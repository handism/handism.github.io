        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 bg-card border border-border rounded-3xl p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-6 pb-4 border-b border-border/60">
              ...
              <h2 className="font-bold text-lg">パラメータ調整</h2>
            </div>
            ...
            {activeTab === 'glass' ? (
              ...
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <label className="text-sm font-semibold text-text/80">背後ぼかし (Blur)</label>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <input
                        ...
                        value={bgColor}
                        onChange={(e) => setBgColor(e.target.value)}
                        className="w-full bg-secondary border border-border rounded-xl px-3 py-2 text-xs font-mono focus:outline-none focus:ring-1 focus:ring-accent"
                      />
                    </div>
                  </div>
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <label className="text-sm font-semibold text-text/80">ボーダー不透明度</label>
                    <span className="text-xs font-mono bg-secondary px-2 py-0.5 rounded text-text/70">
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <label className="text-sm font-semibold text-text/80">ボーダー幅</label>
                    <span className="text-xs font-mono bg-secondary px-2 py-0.5 rounded text-text/70">
                      {borderWidth}px
                    </span>
                  </div>
              ...
              <div className="space-y-6">
                ...
                {/* プリセット調整ボタン */}
                <div>
                  <label className="block text-sm font-semibold text-text/80 mb-2 font-medium">
                    プリセット
                  </label>
                  <div className="grid grid-cols-3 gap-2">
                    <button
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            {/* プレビュー画面 */}
            <div className="bg-card border border-border rounded-3xl p-6 shadow-sm overflow-hidden flex flex-col items-center justify-center min-h-[340px] relative">
              <span className="absolute top-4 left-4 text-xs font-semibold text-text/40 tracking-wider uppercase">
                ライブプレビュー
              </span>
              ...
              {activeTab === 'glass' ? (
                ...
                // Smooth Shadow プレビュー
                <div className="w-full h-full flex items-center justify-center min-h-[260px] bg-secondary/30 rounded-2xl p-8 transition-colors">
                  <div
                    style={{
                      boxShadow: shadowCss
                        .replace('box-shadow:', '')
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5 shadow-sm text-slate-100 flex flex-col justify-between">
              ...
              <div className="font-mono text-xs text-slate-300 bg-slate-950 p-4 rounded-xl border border-slate-900 overflow-x-auto whitespace-pre leading-relaxed">
